...
;(function (root, factory, undef) {
	if (true) {
		// CommonJS
		module.exports = exports = factory(__webpack_require__(/*! ./core */ "./lib/crypto-js/core.js"), __webpack_require__(/*! ./enc-base64 */ "./lib/crypto-js/enc-base64.js"), __webpack_require__(/*! ./md5 */ "./lib/crypto-js/md5.js"), __webpack_require__(/*! ./evpkdf */ "./lib/crypto-js/evpkdf.js"), __webpack_require__(/*! ./cipher-core */ "./lib/crypto-js/cipher-core.js"));
	}
	else {}
...
;(function (root, factory, undef) {
	if (true) {
		// CommonJS
		module.exports = exports = factory(__webpack_require__(/*! ./core */ "./lib/crypto-js/core.js"), __webpack_require__(/*! ./evpkdf */ "./lib/crypto-js/evpkdf.js"));
	}
	else {}
}(this, function (CryptoJS) {
...
;(function (root, factory) {
	if (true) {
		// CommonJS
		module.exports = exports = factory(__webpack_require__(/*! ./core */ "./lib/crypto-js/core.js"));
	}
	else {}
}(this, function (CryptoJS) {
...
;(function (root, factory, undef) {
	if (true) {
		// CommonJS
		module.exports = exports = factory(__webpack_require__(/*! ./core */ "./lib/crypto-js/core.js"), __webpack_require__(/*! ./sha1 */ "./lib/crypto-js/sha1.js"), __webpack_require__(/*! ./hmac */ "./lib/crypto-js/hmac.js"));
	}
	else {}
}(this, function (CryptoJS) {
...
const AES = __webpack_require__(/*! ./aes */ "./lib/crypto-js/aes.js")
const Utf8 = __webpack_require__(/*! ./enc-utf8 */ "./lib/crypto-js/enc-utf8.js")
module.exports = {
  AES,
  enc: {
    Utf8,
...
const crypt = __importStar(__webpack_require__(/*! ../../lib/crypto-js */ "./lib/crypto-js/index.js"));
...
const crypt = __importStar(__webpack_require__(/*! ../../lib/crypto-js */ "./lib/crypto-js/index.js"));
const constants_1 = __webpack_require__(/*! ../constants */ "./src/constants.ts");
const verifyToken = (token, expired = constants_1.DEFAULT_EXPIRATION) => {
    const decryptedTimestamp = parseInt(crypt.AES.decrypt(token, constants_1.SECRET).toString(crypt.enc.Utf8) || '');
    const time = Date.now();
...
const generateToken_1 = __webpack_require__(/*! ./lib/generateToken */ "./src/lib/generateToken.ts");
Object.defineProperty(exports, "generateToken", ({ enumerable: true, get: function () { return generateToken_1.generateToken; } }));
const verifyToken_1 = __webpack_require__(/*! ./lib/verifyToken */ "./src/lib/verifyToken.ts");
